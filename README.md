# docker-stack_drupal
Fresh installation of Drupal (PHP 8, APACHE, MYSQL, PHPMYADMIN, DRUPAL 9.4, drupal/gin THEME)
...
> Launch the website (first wait for the end of the docker stack installation)
http://localhost:8080
